...
{
    class ModelBase : INotifyPropertyChanged, INotifyDataErrorInfo
    {
        [NonSerialized]
        ...
        /// <summary>
        /// Passing null or string.empty in PropertyChangedEventArgs causes 
        /// RaisePropertyChanged to fire for all properties in the model.
        /// </summary>
